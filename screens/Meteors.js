...
import { Text, View, Alert, SafeAreaView, FlatList, Platform, ImageBackground, Image, Dimensions } from 'react-native';
...
export default class MeteorScreen extends Component {
    ...
    renderItem =({item})=>{
        ...
        else if (meteor.threat_score>30 && meteor.threat_score<=75){
        ...
        return(
            <View>
             ...
             <View>
             <Text style={[styles.cardTitle,{marginTop:40,marginLeft:50}]}>{item.name}</Text>
             ...
             <Text style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>Velocity - {item.close_approach_data[0].relative_velocity.kilometers_per_hour}</Text>
             </View>
